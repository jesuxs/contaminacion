...
print(sum(promedio_datos_anual_v)/len(promedio_datos_anual_v))
print(sum(promedio_datos_mensuales_v)/len(promedio_datos_mensuales_v))
print(statistics.stdev(promedio_datos_anual_v))
print(statistics.stdev(promedio_datos_mensuales_v))
# promedio_datos_anual_v
# year=[]
...
# ax.plot(year,promedio_datos_anual_v,linewidth=4,c="green")
# ax.set_title("Promedido anual de la velocidad del viento\n Estación Huancano",fontsize=20)
# ax.set_xlabel("Años",fontsize=20)
# ax.set_ylabel("velocidad (m/s)",fontsize=20)
# ax.tick_params(axis="both",which="major",labelsize=15)
# ax.axis([1995,2020,0,14])
...
# ax.set_title("Promedio estacional de la velocidad del viento \n Estación Huancano",fontsize=20)
